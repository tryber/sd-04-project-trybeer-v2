...
export const postLogin = async (email, password) => axios.post(`${baseUrl}/authenticate`, { email, password });

export const forgotPassword = async (email) => axios.post(`${baseUrl}/authenticate/forgotPassword`, { email });

export const resetPassword = async (email, token, password) => axios.post(`${baseUrl}/authenticate/resetPassword`, { email, token, password });
